#ifndef LINKAPI_LINK_FILESYSTEM_HPP
#define LINKAPI_LINK_FILESYSTEM_HPP
...
public:
  ...
  FileSystem(link_transport_mdriver_t *driver = nullptr);
...
private:
  API_AF(LinkFileSystem, link_transport_mdriver_t *, driver, nullptr);
...
#endif // LINKAPI_LINK_FILESYSTEM_HPP
